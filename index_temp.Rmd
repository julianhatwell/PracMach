...
# This will shift each variable by addition 
# Instead of centering the means around zero
# The intention is to ensure that its entire range is above zero and then take the natural log
# Adding a little extra room for extreme outliers 
